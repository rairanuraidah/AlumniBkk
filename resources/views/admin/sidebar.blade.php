          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="img asop.jpg" alt="..." class="img-circle profile_img">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li>
                    <a href="/alumni"><i class="fa fa-edit"></i> Alumni</a>  
                  </li>
                  <li>
                    <a href="/perusahaan"><i class="fa fa-edit"></i> Perusahaan</a>  
                  </li>
                  <li>
                    <a href="/lowongan"><i class="fa fa-edit"></i> Lowongan</a>  
                  </li>
                  <li>
                    <a href="/lamaran"><i class="fa fa-edit"></i>Lamaran</a>  
                  </li>
