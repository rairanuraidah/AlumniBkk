                        ...
                        <tbody>
                            @foreach ($lowongan as $key => $item)
                                <tr class="text-center">
                                    ...
                                    <td>{{ $item->tanggal }}</td>
                                    <td>
                                        <a href="/lowongan/edit/{{ $item->id_loker }}" class="btn btn-success">
                                        ...
                                        <a href="/lowongan/delete/{{ $item->id_loker }}" onclick="return window.confirm('hapus data ini?')" class="btn btn-danger">
