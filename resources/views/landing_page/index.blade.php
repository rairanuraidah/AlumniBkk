...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <div class="logo">
        <h1><a href="index.html">BKK SMK YPC Tasikmalaya</a></h1>
        ...
        <div class="col-12 hero-text-image">
          <div class="row">
            <div class="col-lg-8 text-center text-lg-start">
              <h1 data-aos="fade-right">Selamat datang di bursa kerja khusus smk ypc</h1>
              <p class="mb-5" data-aos="fade-right" data-aos-delay="100">Temukan pekerjaan yang sesuai dengan keinginanmu</p>
              <p data-aos="fade-right" data-aos-delay="200" data-aos-offset="-500"><a href="#" class="btn btn-outline-white">Get started</a></p>
            </div>
            <div class="col-lg-4 iphone-wrap">
              <img src="{{ asset('SoftLand/assets/img/bkk.png') }}" alt="Image"  width="250" height="250" class="phone-1" data-aos="fade-right">
              <img src="{{ asset('SoftLand/assets/img/bkk.png') }}" alt="Image" width="250" height="250" class="phone-2" data-aos="fade-right" data-aos-delay="200">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-4 ms-auto order-2">
            <h2 class="mb-4 section-heading">TUJUAN</h2>
            <p class="mb-2">1.Sebagai wadah dalam mempertemukan tamatan dengan pencari kerja.</p>
            <p class="mb-2">2.Memberikan layanan kepada tamatan sesuai dengan tugas dan fungsi masing-masing seksi yang ada dalam BKK.</p>
            <p class="mb-2">3.Sebagai wadah dalam pelatihan tamatan yang sesuai dengan permintaan pencari kerja.</p>
            <p class="mb-2">4.Sebagai wadah untuk menanamkan jiwa wirausaha bagi tamatan melalui pelatihan.</p>
          </div>
          <div class="col-md-6" data-aos="fade-right">
            <img src="{{ asset('SoftLand/assets/img/bkk ypc.png') }}" alt="Image" class="img-fluid">
          </div>
        </div>
      </div>
    </section>
